...
const RUNTIME_CONFIG: &[RuntimeConfig] = &[
    ...
    stable("LUX_MAX_ROWS"),
    stable("LUX_MAX_RESP_CONNECTIONS"),
    stable("LUX_MAX_HTTP_CONNECTIONS"),
    stable("LUX_MAX_BLOCKED_CLIENTS"),
    stable("LUX_MAX_RESP_PIPELINE_COMMANDS"),
    stable("LUX_MAX_RESP_COMMAND_ARGS"),
    stable("LUX_MAX_RESP_SUBSCRIPTIONS"),
    stable("LUX_MAX_SUBSCRIPTION_NAME_SIZE"),
    stable("LUX_MAX_LIVE_SUBSCRIPTIONS"),
    stable("LUX_MAX_SUBSCRIPTIONS"),
    stable("LUX_MAX_QUERY_CANDIDATES"),
    stable("LUX_MAX_BLOCKING_KEYS"),
    stable("LUX_MAX_RESP_RESPONSE_SIZE"),
    stable("LUX_MAX_REQUEST_BUFFER_SIZE"),
    stable("LUX_MAX_RESPONSE_BUFFER_SIZE"),
    stable("LUX_MAX_AUTH_WORKERS"),
    stable("LUX_MAX_SCRIPT_MEMORY_SIZE"),
    stable("LUX_RESP_IDLE_TIMEOUT_MS"),
    stable("LUX_RESP_REQUEST_TIMEOUT_MS"),
    stable("LUX_HTTP_HEADER_TIMEOUT_MS"),
