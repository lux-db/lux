...
const INVENTORY: &[CommandInventory] = &[
    ...
    partial(
        "CLIENT",
        "network SETNAME/GETNAME plus SETINFO metadata compatibility; other subcommands error",
    ),
    excluded("CLUSTER", "cluster mode is out of scope"),
    partial(
        "COMMAND",
        "COUNT is supported; metadata forms explicitly error",
    ),
    partial(
        "CONFIG",
        "GET/SET supports the zset listpack threshold; other mutations error",
    ),
    supported("COPY"),
    supported("DBSIZE"),
    partial(
        "DEBUG",
        "registered for compatibility but explicitly unsupported",
    ),
    supported("DECR"),
    supported("DECRBY"),
    supported("DEL"),
    ...
    partial(
        "HELLO",
        "RESP2 identification and AUTH only; RESP3 explicitly unsupported",
    ),
    supported("HEXISTS"),
    supported("HEXPIRE"),
    supported("HEXPIREAT"),
    ...
    partial(
        "MEMORY",
        "USAGE is supported; other subcommands explicitly error",
    ),
    supported("MGET"),
    partial(
        "MIGRATE",
    ...
    partial(
        "OBJECT",
        "ENCODING is supported; other subcommands explicitly error",
    ),
    supported("PERSIST"),
    supported("PEXPIRE"),
    supported("PEXPIREAT"),
    ...
    partial(
        "SELECT",
        "SELECT 0 is a no-op; Lux has no additional databases",
    ),
    supported("SET"),
    supported("SETBIT"),
    supported("SETEX"),
    ...
    lux_native("KUNSUB"),
    lux_native("LUX"),
    excluded("PFDEBUG", "Redis-internal HyperLogLog diagnostic command"),
    lux_native("TALTER"),
    lux_native("TCOUNT"),
    lux_native("TCREATE"),
    lux_native("TDELETE"),
